...
const EN_TEXTS = Object.freeze({
  ...
  turnTimerHint: "Shows a countdown for every human or online turn. The active side auto-skips at zero; AI turns pause without skipping.",
  yourSide: "Your Side",
  ...
  aiModeWhite: "AI Second",
  aiModeBlack: "AI First",
...
const ZH_TEXTS = Object.freeze({
  ...
  turnTimerHint: "开启后显示每回合读秒；人人与联机回合归零时自动跳过，AI 回合暂停读秒且不会因超时跳过。",
  yourSide: "你的阵营",
  turnCount: "回合数",
  legalMoves: "合法落点",
  blueTerritory: "蓝方领地",
...
const EN_ACADEMIC_TEXT_OVERRIDES = Object.freeze({
  ...
  turnTimerHint: "Shows a countdown for each human or synchronized iteration. The active node skips at zero; AI iterations pause without skipping.",
...
const ZH_ACADEMIC_TEXT_OVERRIDES = Object.freeze({
  ...
  turnTimerHint: "开启后显示每次迭代计时；本地多人及同步迭代归零时自动跳过，AI 迭代暂停且不会因超时跳过。",
  yourSide: "当前节点",
  turnCount: "迭代次数",
  legalMoves: "合法动作",
